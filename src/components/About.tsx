  ...
  return (
    ...
    >
      ...
      <Typography color="text.secondary" paragraph>
        ...
        My favorite hobbies include coding, cooking and playing video games. I
        am currently a 4th year computer science student at Texas A&M. Thus far
        my experience has been primarily in front end development, testing use
        cases, and collaborative coding projects. My main contributions at the
        Texas Center for Applied Technology granted me a lot of front end
