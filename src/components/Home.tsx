      ...
      <Box display="flex"  justifyContent={"center"} alignItems={"center"} height="90vh" >
          <Box width="min-content" display="inline-block" zIndex={1}>
            <Typography              
              ...
              textShadow: mode === "dark" ? "1px 1px 2px #FFF, 0 0 1em #FFF, 0 0 0.2em #FFF" : "#000 0 0 2px"
            }}
              color="text.primary"
              fontWeight={800}
            ...
            <Typography
              ...
              fontWeight={1000}
              sx={{textShadow: mode === "dark" ? "1px 1px 2px #FFF, 0 0 1em #FFF, 0 0 0.2em #FFF" : "#000 0 0 10px"}}
              color="text.primary"
              textAlign={"center"}
              fontSize={"10rem"}>
              Tony Qing
        ...
        <Box position={"absolute"} display="flex" justifyContent={"center"} alignItems={"center"} > 
          {!matches ? <img alt="mobile background" src={mode === "dark" ? greymobile : yellowmobile} style={{  objectFit: "cover", width: "80vw", maxHeight: "80vh",  position: "absolute", borderRadius: "6px", transition: "opacity 500ms",   boxShadow: mode === "dark" ? "0px 0px 50px 20px black" : "0px 0px 50px 20px rgb(255, 254, 168)" }}/> : heroImages[mode].map((src, i) => <img alt="homepage background"  src={src} style={{  objectFit: "cover", width: "80vw", maxHeight: "80vh",  position: "absolute", borderRadius: "6px", transition: "opacity 500ms", opacity: i === heroIndex % heroImages[mode].length ? 1 : 0,   boxShadow: mode === "dark" ? "0px 0px 50px 20px black" : "0px 0px 50px 20px rgb(255, 254, 168)" }}/> )}
        </Box>
